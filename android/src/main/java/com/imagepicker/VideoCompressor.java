...
/**
 * Created by camlahoud on 12/20/16.
 */
...
public class VideoCompressor {
    ...
    /** The source file for the encoded input. */
    private String mInputFile;
    /** Start time in milliseconds. 0 or less means start from beginning*/
    private long startTime = -1;
    /** End time in milliseconds. -1 means continue till end */
    private long endTime = -1;

    /**
     * Constructor
     */
    public VideoCompressor(String input, String output) {
        mInputFile = input;
        mOutputFile = output;
    }
     ...
     */
    public void setCopyVideo(Boolean copy) {
        mCopyVideo = copy;
    }
    /**
     * Sets the test to copy the video stream.
     */
    public void setCopyAudio(Boolean copy) {
        mCopyAudio = copy;
    }
    /**
     ...
     * Set video bitrate
     */
    public void setOutputVideoBitrate(int bitrate) {
        OUTPUT_VIDEO_BIT_RATE = bitrate;
    }

    /**
     * Set video frame rate
     */
    public void setOutputVideoFramerate(int framerate) {
        OUTPUT_VIDEO_FRAME_RATE = framerate;
    }

    /**
     * Set video iframe rate
     */
    public void setOutputVideoIFrameInterval(int interval) {
        OUTPUT_VIDEO_IFRAME_INTERVAL = interval;
    }

    /**
     * Set audio bitrate
     */
    public void setOutputAudioBitrate(int bitrate) {
        OUTPUT_AUDIO_BIT_RATE = bitrate;
    }
    ...
    public void extractDecodeEditEncodeMux() throws Exception {
        ...
        try {
            if (mCopyVideo) {
                ...
                if (startTime>0) {
                    videoExtractor.seekTo( startTime * 1000, MediaExtractor.SEEK_TO_PREVIOUS_SYNC );
                }
            ...
            Log.e(TAG, "IO Exception: " + e.getMessage().toString());
        } finally {
