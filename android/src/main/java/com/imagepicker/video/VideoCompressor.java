...
public class VideoCompressor {
     ...
     * @return
     */
    public void setOutputVideoBitrate(int rate) {
        bitrate = rate;
    }

    @TargetApi(16)
    public boolean convertVideo(final String videoPath, final String outputPath) {
...
//        String height = retriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_VIDEO_WIDTH);
        ...
        rotateRender = rotationValue;

        Log.i(TAG, "Rotation value read: "+rotationValue);
...
//        }
        ...
        Log.i(TAG, String.format("Rot: %d, OW: %d, OH: %d, RW: %d, RH: %d",rotationValue,originalWidth,originalHeight,resultWidth,resultHeight));
                    ...
                    if (videoIndex >= 0) {
                        ...
                        try {
                            ...
                            if (Build.VERSION.SDK_INT < 18) {
                                ...
                                Log.i(TAG, "codec = " + codecInfo.getName() + " manufacturer = " + manufacturer + "device = " + Build.MODEL);
                            } else {
                                        ...
                                        if (decoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                                            ...
                                            if (startTime > 0 && videoTime == -1) {
                                                if (info.presentationTimeUs < startTime) {
                                                    doRender = false;
                                                    Log.i(TAG, "drop frame startTime = " + startTime + " present time = " + info.presentationTimeUs);
                                                } else {
